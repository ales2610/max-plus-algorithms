...
%         ignored so that all iterations are shown
%
% OUTPUT:
% delta_min : estimated lower bound on the average deviation
% delta_max : estimated upper bound on the average deviation
...
% analysis for max-plus stochastic systems.
    ...
    for m = 1:M
        ...
        for k = 0:N_max-1
            ...
            % Early stopping if bounds are sufficiently tight
